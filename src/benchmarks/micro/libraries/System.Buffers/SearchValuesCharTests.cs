...
namespace System.Buffers.Tests
{
    ...
    public class SearchValuesStringTests_SingleString
    {
        ...
        //[Benchmark] public bool Throughput() => s_text_noMatches.AsSpan().Contains(Needle, StringComparison.Ordinal);
        [Benchmark] public bool SV_Throughput() => s_text_noMatches.AsSpan().ContainsAny(s_values);
        [Benchmark] public bool SV_ThroughputIC() => s_text_noMatches.AsSpan().ContainsAny(s_valuesIC);

        //[Benchmark] public bool FalsePositives() => s_text_falsePositives.AsSpan().Contains(Needle, StringComparison.Ordinal);
        [Benchmark] public bool SV_FalsePositives() => s_text_falsePositives.AsSpan().ContainsAny(s_values);
        [Benchmark] public bool SV_FalsePositivesIC() => s_text_falsePositives.AsSpan().ContainsAny(s_valuesIC);

        //[Benchmark] public bool SV_EarlyMatch() => s_text_earlyMatch.AsSpan().ContainsAny(s_values);
        //[Benchmark] public bool SV_EarlyMatchIC() => s_text_earlyMatch.AsSpan().ContainsAny(s_valuesIC);
    }
#endif
}
